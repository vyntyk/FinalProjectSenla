@echo off
REM This script combines docker-compose.yml and Dockerfile into a single file
REM for reference purposes. The original files remain unchanged and functional.

REM Create the combined file
